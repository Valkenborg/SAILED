...
In this notebook we demonstrated that one should not use (untransformed) intensities in a model-based normalization as the former putatively exhibit multiplicative biases, but the latter can only apply additive corrections. Mixing additive and multiplicative scales tends to give distorted results, including when using (intensity-based) ratios. 
